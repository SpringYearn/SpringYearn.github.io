...
const copy = {
  en: {
    ...
    intro:
      "A growing archive across editing, motion, 3D, drawing and graphic image — arranged by medium, connected by rhythm.",
    count: "Open archive / Taiwan",
    filters: { all: "All", editing: "Editing / Motion", "3d": "3D", drawing: "Drawing" },
  ...
  zh: {
    ...
    intro: "持續整理剪輯、動態圖形、3D、繪畫與平面影像，媒介彼此不同，卻共享同一種節奏。",
    count: "開放式創作檔案／台灣",
    filters: { all: "全部", editing: "剪輯／動態圖形", "3d": "3D", drawing: "繪畫" },
